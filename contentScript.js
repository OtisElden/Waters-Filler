...
async function initializeTesseract() {
    ...
    await worker.load();
    await worker.loadLanguage('eng'); // or other languages as needed
    await worker.initialize('eng');   // or other languages as needed
}
...
function patientWatcher() {
    function checkForField() {
        // Query all buttons with class 'button-control'
        ...
        if (foundButton) {
            ...
            handleFile("testocr.png"); // Call your function here
...
patientWatcher(); // Initialize the watcher
